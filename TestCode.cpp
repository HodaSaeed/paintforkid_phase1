...
int main()
{
	...
	pOut->PrintMessage("Drawing a Line Test ==> OK,   Click two points");
	pIn->GetPointClicked(P1.x, P1.y);
	pIn->GetPointClicked(P2.x, P2.y);
	...
	pOut->PrintMessage("Drawing a line ==> Highlighted filled, Click to Highlight");
	pIn->GetPointClicked(x, y);	//Wait for any click
	pOut->Drawline(P1, P2, gfxInfo, true);



	pOut->PrintMessage("Drawing a line ==> OK,  Click anywhere to continue");
	pIn->GetPointClicked(x, y);	//Wait for any click
	pOut->ClearDrawArea();
	...
	// 2.4.4 - Drawing a highlighted filled rectangle
